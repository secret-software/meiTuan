...
class me_Rotating_item extends StatefulWidget {
  me_Rotating_item({Key? key}) : super(key: key);

  @override
  _me_Rotating_itemState createState() => _me_Rotating_itemState();
}

class _me_Rotating_itemState extends State<me_Rotating_item> {
